...
#Script used to embed texts using Count vectorisation. 
...
def countvect(path):
    ...
    vectorizer = CountVectorizer(input = 'filename', stop_words = list_stopwords)
    ...
    result_file = open("../storage/table_countvect_clustering/filenames.csv",'w')
